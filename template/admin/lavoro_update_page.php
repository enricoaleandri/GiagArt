...
<body>
<div id="background_lavoro_update" class="background ">
    <center>
        <div id="wrapper">
            <?php
            ...
            <span class="Vdivider">
                    ...
                    <span id="admin_content">
                        ...
                        <div class="wrapper">
                            ...
                            <span class="details">
                                <form method="POST" name="details" id="details" action="<?php echo $host;?>/lavori/saveupdate">
                                    <input type="hidden" name="id_lavoro_parent" value="<?php echo $lavoro->getIdLavoroParent();?>" />
                                    <input type="hidden" name="id_lavoro" value="<?php echo $lavoro->getIdLavoro();?>" />
                                    <input type="hidden" name="id_autore" value="<?php echo $lavoro->getIdAutore();?>" />
                                    <div class="title">
                                        <label>Titolo</label>
                                        <input type="text" value="<?php echo $lavoro->getTitolo();?>" name="titolo" id="titolo" />
                                    </div>
                                    <div class="description">
                                        <label>Descrizione</label>
                                        <textarea name="descrizione" id="descrizione" style="width: 100%; height:250px;"><?php echo $lavoro->getDescrizione();?></textarea>
                                    </div>
                                    <div class="category">
                                        <label>Categoria</label>
                                            <select name="categoria" id="categoria" >
                                                ...
                                                {
                                                    if($riga['id_categoria'] == $lavoro->getIdLavoro())
                                                        echo "<option selected='selected' value='".$riga['id_categoria']."'>".$riga['nome_categoria']."</option>";
                                                    else
                                    ...
                                    <div class="tags">
                                        ...
                                        <textarea name="tags" id="tags" style="width: 100%; height:160px;"><?php echo $lavoro->getTags();?></textarea>
                                    </div>
                                    <div class="status">
                                        <label>Stato</label>
                                        <select name="status" id="status">
                                            <option value="0" <?php if($lavoro->getStatus() == 0) echo "selected='selected'";?>> Bozza</option>
                                            <option value="1" <?php if($lavoro->getStatus() == 1) echo "selected='selected'";?>> Privato</option>
                                            <option value="2" <?php if($lavoro->getStatus() == 2) echo "selected='selected'";?>> Pubblico</option>
                                        </select>
                                    </div>
